...
{REDUND_ERROR} FUNCTION_BLOCK MTProfileFunctionGenerator (*Function generator.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpControlTools.png *)
	VAR_INPUT
...
{REDUND_ERROR} FUNCTION_BLOCK MTProfilePositionGenerator (*Position generator.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpControlTools.png *)
	VAR_INPUT
		Enable : {REDUND_UNREPLICABLE} BOOL; (*Enables/Disables the function block.*)
