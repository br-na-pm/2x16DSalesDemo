TYPE
	McPVAHModEnum :
		...
		mcPVAHM_RES_POS := 10, (*Restore position - Homing by restoring the position from permanent variable data*)
	...
	McPVADIAllSrcEnum :
		...
		mcPVADIAS_IO_CH := 2 (*I/O channel - Get value frome an I/O channel*)
		);
	...
	McPVADIAllTrgSrcEnum :
		...
		mcPVADIATS_IO_CH := 2 (*I/O channel - Get value frome an I/O channel*)
		);
	...
	McPVADIQstopInEnum :
		...
		mcPVADIQI_IO_CH := 7 (*I/O channel - Get value frome an I/O channel*)
		);
	...
	McPVADIQstopInIOChType : STRUCT (*Type mcPVADIQI_IO_CH settings*)
		ChannelMapping : STRING[250]; (*Channel as input source*)
	END_STRUCT;
